...
<div class="d-flex">
    <nav class="sidebar">
        ...
        <a href="tutoriais.html" style="font-weight: bold"><p class="titles-dashboard"><i class="bi bi-terminal-dash icons-navbar"></i> &nbsp;Tutoriais & Dicas</p></a>
        ...
        <div class="list-group-item box-content">
           <div class="f-flex">
               <div class="mr-auto p-2">
                    <h3 class="display-4 title-content">Tutoriais & Dicas</h3>
               </div>
