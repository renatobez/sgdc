...
<div class="d-flex">
    <nav class="sidebar">
        ...
        <a href="settings.html" style="font-weight: bold"><p class="titles-dashboard"><i class="bi bi-gear icons-navbar"></i> &nbsp;Configurações</p></a>
    </nav>
        ...
        <div class="list-group-item box-content">
           <div class="f-flex">
               <div class="mr-auto p-2">
                    <h3 class="display-4 title-content">Configurações</h3>
               </div>
