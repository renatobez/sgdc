...
<head>
    ...
    <title>rbsCoud - Marketing Digital</title>
</head>
<body class="painel">
...
<div class="d-flex">
    <nav class="sidebar">
        ...
        <a href="mdigital.html" style="font-weight: bold"><p class="titles-dashboard"><i class="bi bi-bullseye"></i> &nbsp;Marketing Digital</p></a>
        ...
        <div class="list-group-item box-content">
           <div class="f-flex">
               <div class="mr-auto p-2">
                    <h3 class="display-4 title-content">Marketing Digital</h3>
               </div>
